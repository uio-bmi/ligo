...
from ligo.ml_methods.pytorch_implementations.PyTorchLogisticRegression import PyTorchLogisticRegression
...
class AtchleyKmerMILClassifier(MLMethod):
    ...
    def get_compatible_encoders(self):
        from ligo.encodings.atchley_kmer_encoding.AtchleyKmerEncoder import AtchleyKmerEncoder
