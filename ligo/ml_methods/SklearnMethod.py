...
from ligo.ml_methods.util.Util import Util
from ligo.ml_metrics.Metric import Metric
from ligo.util.FilenameHandler import FilenameHandler
...
class SklearnMethod(MLMethod):
    ...
    def get_compatible_encoders(self):
        from ligo.encodings.evenness_profile.EvennessProfileEncoder import EvennessProfileEncoder
        from ligo.encodings.kmer_frequency.KmerFrequencyEncoder import KmerFrequencyEncoder
        from ligo.encodings.onehot.OneHotEncoder import OneHotEncoder
        from ligo.encodings.word2vec.Word2VecEncoder import Word2VecEncoder
        from ligo.encodings.reference_encoding.MatchedSequencesEncoder import MatchedSequencesEncoder
        from ligo.encodings.reference_encoding.MatchedReceptorsEncoder import MatchedReceptorsEncoder
        from ligo.encodings.reference_encoding.MatchedRegexEncoder import MatchedRegexEncoder
