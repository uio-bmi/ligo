...
class SimConfigItem:
    ...
    name: str = ""
    is_noise: bool = False
    seed: int = None # starting random seed for the generative model (it should differ across simulation items, or it can be set to null when not used), does not work for OLGA
